...
def talker_for_servo_commands():
    ...
    while not rospy.is_shutdown(): 
        ...
        if count==2:
            servo_command_0 = 750  #something between 500 and 2500
            count = 0
        else:
            servo_command_0 = 1050
...
if __name__ == "__main__": 
    ...
    except ValueError:    # This will happen when you enter something the "input" or "int" cannot handle. That's the usual way to end this node. 
        print('Bad entry, exiting.')
        pass        
    except :            # This will catch other errors and tell you what they are. 
        traceback.print_exc()
        pass
